package org.nexora.example.configuration;

import org.nexora.example.services.UserService;
...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        return username -> {
            org.nexora.example.model.User user = userService.findByUsername(username);
            if (user == null) {
